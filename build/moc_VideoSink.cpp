/****************************************************************************
** Meta object code from reading C++ file 'VideoSink.h'
**
...
#include <memory>
#include "../Sources/VideoRender/VideoSink.h"
...
#error "The header file 'VideoSink.h' doesn't include <QObject>."
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_VideoRender_t::offsetsAndSizes) + ofs), len 
static const qt_meta_stringdata_VideoRender_t qt_meta_stringdata_VideoRender = {
    {
        QT_MOC_LITERAL(0, 11)   // "VideoRender"
    },
    "VideoRender"
};
...
const QMetaObject VideoRender::staticMetaObject = { {
    ...
    qt_meta_stringdata_VideoRender.offsetsAndSizes,
    qt_meta_data_VideoRender,
    qt_static_metacall,
    nullptr,
qt_incomplete_metaTypeArray<qt_meta_stringdata_VideoRender_t
, QtPrivate::TypeAndForceComplete<VideoRender, std::true_type>
